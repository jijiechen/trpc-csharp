...
namespace TrpcSharp.Server.TrpcServices
{
    ...
    /// 
    /// The bind method signature takes a <see cref="TrpcServiceBinderBase"/> and an optional
    /// instance of the service base class, e.g. <c>static void BindService(ServiceBinderBase, GreeterService)</c>.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = true)]
    public class BindTrpcServiceAttribute : Attribute
    {
...
#endif
        /// <summary>
        /// Initializes a new instance of the <see cref="BindTrpcServiceAttribute.Core.BindServiceMethodAttribute"/> class.
        /// </summary>
        ...
        public BindTrpcServiceAttribute(
#if NET5_0_OR_GREATER
            [DynamicallyAccessedMembers(ServiceBinderAccessibility)]
#endif 
                Type bindType, string bindMethodName)
        {
            BindType = bindType;
