...
{
    internal static class BindTrpcServiceMethodFinder
    {
        ...
        internal static MethodInfo GetBindMethodUsingAttribute(Type serviceType)
        {
            ...
            BindTrpcServiceAttribute bindServiceMethod;
            do
            {
                ...
                bindServiceMethod = currentServiceType.GetCustomAttribute<BindTrpcServiceAttribute>();
                if (bindServiceMethod != null)
                {
                    ...
                    return bindServiceMethod.BindType.GetMethod(
                        ...
                        binder: null,
                        new[] { typeof(TrpcServiceBinderBase), currentServiceType },
        ...
        internal static MethodInfo GetBindMethodFallback(Type serviceType)
        {
            ...
            return declaringType?.GetMethod(
                ...
                BindMethodBindingFlags,
                binder: null,
                new[] { typeof(TrpcServiceBinderBase), baseType },
                Array.Empty<ParameterModifier>());
        }
